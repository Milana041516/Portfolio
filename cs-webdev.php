...
$query1 = 'SELECT projects.id AS project, title, overview, role, process, challenges, tools_used, result, project_url, image_main, GROUP_CONCAT(image_gallery) AS images FROM projects, media WHERE media.projects_id = projects.id AND projects.categories_id = 1 AND projects.id ='.$_GET['id'];
